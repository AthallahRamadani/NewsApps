package com.mandiri.aplikasiberita.data.utils

import com.mandiri.aplikasiberita.data.datasource.remote.api.response.EverythingResponse
import com.mandiri.aplikasiberita.data.datasource.remote.api.response.HeadlineResponse
import com.mandiri.aplikasiberita.data.datasource.remote.api.response.Source
import com.mandiri.aplikasiberita.data.datasource.remote.api.response.SourceEverything
...
fun com.mandiri.aplikasiberita.data.datasource.remote.api.response.ArticlesItemEverything.toEverythingPaging(): ArticlesItemEverything {
